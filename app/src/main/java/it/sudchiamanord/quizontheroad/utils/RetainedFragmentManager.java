...
class RetainedFragmentManager
{
     ...
     */
    RetainedFragmentManager(FragmentManager fragmentManager, String retainedFragmentTag)
    {
    ...
    boolean firstTimeIn()
    {
        try {
            ...
            // a tag.
            mRetainedFragment = (RetainedFragment) mFragmentManager.get().findFragmentByTag(
            ...
            if (mRetainedFragment == null) {
                ...
                mFragmentManager.get().beginTransaction().add(mRetainedFragment,
...
//
//            try {
//                mCallback = (OperationProgressListener) activity;
//            }
